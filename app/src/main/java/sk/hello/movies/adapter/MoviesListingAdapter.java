package sk.hello.movies.adapter;
...
import sk.hello.movies.utils.Api;
...
public class MoviesListingAdapter extends RecyclerView.Adapter<MoviesListingAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, int position) {
        ...
        holder.release.setText(holder.movie.getReleaseDate());
        holder.rating.setText(""+holder.movie.getVoteAverage());
