...
public class SortingDialogPresenter implements sk.hello.movies.interfaces.SortingDialogPresenter {
    private SortingDialogView view;
    private SortingDialogInterface sortingDialogInterface;

    public SortingDialogPresenter(SortingDialogInterface interactor) {
